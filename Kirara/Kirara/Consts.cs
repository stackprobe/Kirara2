...
namespace Charlotte
{
	public class Consts
	{
		...
		public const int SCREEN_MARGIN = 100; // クライアント領域とウィンドウ領域の差を考慮したマージン
		public const int MONITOR_W_MIN = SCREEN_W_MIN + SCREEN_MARGIN;
		public const int MONITOR_H_MIN = SCREEN_H_MIN + SCREEN_MARGIN;
	}
}
