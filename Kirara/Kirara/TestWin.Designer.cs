namespace Charlotte
{
	partial class TestWin
	{
		...
		private void InitializeComponent()
		{
			...
			this.button2.Text = "Conv動画no-mst";
			...
			this.button4.Text = "Conv音楽no-mst";
			...
			this.textBox1.Size = new System.Drawing.Size(307, 237);
			this.textBox1.TabIndex = 5;
			// 
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(240, 180);
